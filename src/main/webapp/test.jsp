...
%>
                    ...
                    <h2 class="h3 mb-0 text-gray-800" style="color:#69BC69 ; font-family:Helvetica, sans-serif">This week's target spend was € <input type="text" name="lastTarget" id="txtLastTarget" value="<%=rs.getString("target_value")%>"></h2>
        <%
            }
            }
        catch(Exception e){
        ...
        %>
                    ...
                    <div class="box2" style="margin-left:20px"></div> 
                    <a style="margin-left:20px">Food Price (€)</a>
                        </div>
                   
                     <div class="float-child">
                    <div class="box" style="margin-left:20px"></div> 
                    <a style="margin-left:20px">Targets (€) </a>
                     </div>
                    </div>
