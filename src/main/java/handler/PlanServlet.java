...
public class PlanServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    String planMeasurement = request.getParameter("plan_measurement");
    String planId = request.getParameter("plan_id");
    String date = request.getParameter("date");
    String targetValue = request.getParameter("target_value");
    ...
    try {
       ConnectionProvider dmbgr = new ConnectionProvider();
        Connection con = dmbgr.getConnection();
          ...
          stmt.executeUpdate("insert into plans (id,plan_measurement,plan_id,name)values('"+userId+"','"+planMeasurement+"','"+planId+"','"+name+"') ");
...
//      JLabel label1 = new JLabel("A program will made made for " + planMeasurement + " euro");
